 ...
 * @param {object} dataToUpdate - An object containing the fields and values to update (e.g., { state: 'NEW_STATE', edit_msg_id: 123 }). Must not be empty. Allowed fields include: state, session_type, conversation_history, booking_slot, edit_msg_id.
