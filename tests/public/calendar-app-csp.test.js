...
describe('Calendar App CSP and Custom Elements', () => {
  ...
  describe('Content Security Policy', () => {
    ...
    test('should not have conflicting CSP directives', () => {
      ...
      const cspMetaMatches = calendarHtml.match(/<meta[^>]*http-equiv=["']Content-Security-Policy["'][^>]*>/gi);
  ...
  describe('Custom Elements', () => {
    ...
    test('should have proper development mode detection', () => {
      ...
      const stagewiseScriptPath = path.join(__dirname, '../../public/stagewise-working.js');
  ...
  describe('Form Loading', () => {
    ...
    test('should extract parameters from flowToken when missing from URL', () => {
      ...
      params.appointmentDateTimeISO = mockSearchParams.get('appointmentDateTimeISO');
      ...
      if (params.flowToken && (!params.telegramId || !params.sessionTypeId || !params.appointmentDateTimeISO)) {
        ...
        if (tokenParts.length === 3) {
          ...
          if (!params.appointmentDateTimeISO && decodedPayload.appointmentDateTimeISO) {
            params.appointmentDateTimeISO = decodedPayload.appointmentDateTimeISO;
          }
        }
      }
    ...
    test('should support various Kambo waiver form types', () => {
      ...
      supportedFormTypes.forEach(formType => {
        const isSupported = formType === "KAMBO_WAIVER_V1" || 
      ...
      const isUnsupported = unsupportedType === "KAMBO_WAIVER_V1" || 
