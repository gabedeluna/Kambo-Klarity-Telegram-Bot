...
describe('Command Handlers (src/commands/handlers.js)', () => {
  ...
  beforeEach(() => {
    ...
    mockCtx = {
      ...
      message: { text: '' },
      state: {
        user: { telegram_id: 'user123', role: 'client', first_name: 'TestUser' },
  ...
  describe('handleClientHelpStub', () => {
    it('should reply with the client help stub message', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith("Stub: Client Help - List of your available commands.");
    });
  });
  ...
  describe('handleAdminHelpStub', () => {
    it('should reply with the admin help stub message', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith("Stub: Admin Help - List of your admin commands.");
    });
  });
  ...
  describe('handleContactAdminStub', () => {
    it('should reply with the /contact_admin stub message', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith("Stub: /contact_admin command");
    });
  });
  ...
  describe('listSessionsStub', () => {
    it('should reply with the /sessions stub message', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith("Stub: /sessions command (admin)");
    });
  });
  ...
  describe('broadcastStub', () => {
    it('should reply with the /broadcast stub message', async () => {
      ...
      expect(mockCtx.reply).toHaveBeenCalledWith("Broadcast command placeholder.");
    });
  });
});