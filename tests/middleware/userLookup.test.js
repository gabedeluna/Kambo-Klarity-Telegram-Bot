...
describe("Middleware: userLookup", () => {
  ...
  describe('initialize', () => {
    it('should initialize with valid dependencies', () => {
      ...
      expect(mockLogger.info).to.have.been.calledWith('[userLookupMiddleware] Initialized successfully.');
  ...
  describe('userLookupMiddleware', () => {
    ...
    it('should call next and log error if used before initialization', async () => {
      ...
      delete require.cache[require.resolve('../../src/middleware/userLookup')];
      const { userLookupMiddleware: uninitializedMiddleware } = require('../../src/middleware/userLookup');
      ...
      // Assert
      expect(consoleErrorStub).to.have.been.calledWith("FATAL: userLookupMiddleware used before initialization.");
      expect(nextSpy).to.have.been.calledOnce;
    });
  });
});
