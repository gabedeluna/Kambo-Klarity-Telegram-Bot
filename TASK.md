...
| [ ]**PH6‑05** | **DB: Populate Initial Session Types**                                                              | Create a one-time script (e.g., `bin/populate_session_types.js`) or manually populate the `SessionType` table with initial data from `src/config/sessionTypes.json`. *Pass*: `SessionType` table contains the initial session types.                                                                                                                                                                             |
