...
| [ ]**PH5‑05** | **Consolidate Express Server**                                          | Merge `legacy/server.js` features (static file serving, `/`) into `src/app.js`.                                                                                                     | *Pass*: `app.js` serves `public/index.html` at `/`. Legacy server code can be removed later. |
